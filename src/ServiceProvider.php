...
class ServiceProvider extends LumenServiceProvider
{
    ...
    {
        Validator::extend('applicationable_alias', 'Nebo15\LumenApplicationable\Validator@alias');
        Validator::extend('required_scopes', 'Nebo15\LumenApplicationable\Validator@requiredScopes');
